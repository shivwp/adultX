                                    ...
                                    <form method="POST" action="{{ route('storeuser') }}">
                                        ...
                                        <div class="singpform-wraper">
                                            ...
                                            <div class="inputfild-wrapp" style="border-bottom: 1px solid #193147">
                                                ...
                                                <input type="email" placeholder="Email" class="email-adrrs"
                                                    name="email" />
                                                <small class="text-danger">
                                                    @error('email')
                                                        {{ $message }}
                                            ...
                                            <div class="inputfild-wrapp">
                                                ...
                                                <input type="password" placeholder="Password" class="lockpassword"
                                                    name="password" />
                                                <small class="text-danger">
                                                    @error('password')
                                                        {{ $message }}
                                        ...
                                        <div class="checkinput-wraper">
                                            <input type="checkbox" class="ckeckoutinpt" name="readbox" />
                                            <p>
                                    ...
                                    <div class="tab-pane fade show active loginform-wrapper" id="pills-home"
                                        ...
                                        <form method="POST" action="{{ route('mainlogin') }}">
                                            ...
                                            <div class="singpform-wraper">
                                                ...
                                                <div class="inputfild-wrapp">
                                                    ...
                                                    <input type="password" placeholder="Password"
                                                        class="lockpassword" name="password" />
                                                    <small class="text-danger">
                                                        @error('password')
                                                            {{ $message }}
                                                        @enderror
                                            ...
                                            <div class="checkinput-wraperonlogin">
                                                <div class="checkinput-wraper">
                                                    <input type="checkbox" class="ckeckoutinpt" name="acceptbox" />
                                                    <p>Remember Me</p>
                                                    <small class="text-danger">
                                                        @error('acceptbox')
                                                            {{ $message }}
