                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="dob" placeholder="DOB"
                                value="{{ old('dob', isset($model->dob) ? $model->dob : '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="Last Name"
                                value="{{ old('email', isset($model->email) ? $model->email : '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="phone" placeholder="Phone number"
                                value="{{ old('phone', isset($model->phone) ? $model->phone : '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city" placeholder="City"
                                value="{{ old('city', isset($model->city) ? $model->city : '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="state" placeholder="State"
                                value="{{ old('state', isset($model->state) ? $model->state : '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="gender" class="form-control" required>
                                ...
                                <option value="female"
                                    {{ isset($model->gender) && $model->gender == 'female' ? 'selected' : '' }}>Female
                                </option>
                                        ...
                                        <div class="parc">
                                            <span class="pip" data-title="{{ $multidata }}">
                                                ...
                                                <a class="btn"><i class="fa fa-times remove"
                                                        onclick="removeImage('{{ $multidata }}')"></i></a>
                                            </span>
                                        </div>
                                    @endforeach
                                </div>
                            @endif
                            <input type="hidden" name="gallery_images_old" id="gallery_img"
                                value="{{ $model->gallery_image }}">
                        @endif
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="phone" class="form-control" required>
                                ...
                                <option value="1"
                                    {{ isset($model->phone) && $model->phone == 1 ? 'selected' : '' }}>yes</option>
                                <option value="0"
                                    {{ isset($model->phone) && $model->phone == 0 ? 'selected' : '' }}>
                                    No</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="video" class="form-control" required>
                                <option value="">Select</option>
                                <option value="1"
                                    {{ isset($model->video) && $model->video == 1 ? 'selected' : '' }}>yes</option>
                                <option value="0"
                                    {{ isset($model->video) && $model->video == 0 ? 'selected' : '' }}>
                                    No</option>
                            </select>
                        </div>
                    </div>
                                ...
                                @if (count($model_orient) > 0)
                                    @foreach ($model_orient as $value)
                                        <option value="{{ $value->title }}"
                                            {{ isset($model->Orientation) && $model->Orientation == $value->title ? 'selected' : '' }}>
                                            {{ $value->title }}</option>
                                    @endforeach
                                @endif
                                ...
                                @if (count($model_cate) > 0)
                                    @foreach ($model_cate as $cate)
                                        <option value="{{ $cate->title }}"
                                            {{ isset($model->Model_Category) && $model->Model_Category == $cate->title ? 'selected' : '' }}>
                                            {{ $cate->title }}</option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <select name="ethnicity" class="form-control" required>
                                ...
                                @if (count($model_ethnic) > 0)
                                    @foreach ($model_ethnic as $ethnic)
                                        <option value="{{ $ethnic->title }}"
                                            {{ isset($model->Ethnicity) && $model->Ethnicity == $ethnic->title ? 'selected' : '' }}>
                                            {{ $ethnic->title }}</option>
                                    @endforeach
                                @endif
                            </select>
                                ...
                                @if (count($model_lang) > 0)
                                    @foreach ($model_lang as $lang)
                                        <option value="{{ $lang->title }}"
                                            {{ isset($model->Language) && $model->Language == $lang->title ? 'selected' : '' }}>
                                            {{ $lang->title }}</option>
                                    @endforeach
                                @endif
                            ...
                            <select name="hair" class="form-control" required>
                                ...
                                @if (count($model_hair) > 0)
                                    @foreach ($model_hair as $hair)
                                        <option value="{{ $hair->title }}"
                                            {{ isset($model->Hair) && $model->Hair == $hair->title ? 'selected' : '' }}>
                                            {{ $hair->title }}</option>
                                    @endforeach
                                @endif
                            ...
                            <select name="fetishes" class="form-control" required>
                                ...
                                @if (count($model_fet) > 0)
                                    @foreach ($model_fet as $fet)
                                        <option value="{{ $fet->title }}"
                                            {{ isset($model->Fetishes) && $model->Fetishes == $fet->title ? 'selected' : '' }}>
                                            {{ $fet->title }}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="url1" placeholder="Enter Your First Url"
                                value="{{ old('url1', isset($model->url1) ? $model->url1 : '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="url2"
                                ...
                                value="{{ old('url2', isset($model->url2) ? $model->url2 : '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="url3" placeholder="Enter Your Third Url"
                                value="{{ old('url3', isset($model->url3) ? $model->url3 : '') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="link6" placeholder="Enter CamSite Url"
                                value="{{ isset($social_link->camsite) ? $social_link->camsite : '' }}" required>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="costmsg" placeholder="Enter Your Cost"
                                value="{{ old('costmsg', isset($model->cost_msg) ? $model->cost_msg : '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">Cost per Picture</label>
                            <input type="text" class="form-control" name="costpicture" placeholder="Enter Your Cost"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="costvideo_msg"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="costaudio_msg"
                                placeholder="Enter Your Cost"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="costaudio_call"
                                placeholder="Enter Your Cost"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="cost_videocall"
                                placeholder="Enter Your Cost"
