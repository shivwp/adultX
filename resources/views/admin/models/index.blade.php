                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                {{--<a class="btn btn-sm btn-primary" href=""><i class="fa fa-eye"></i></a>--}}
                                                                 ...
                                                                 <a class="btn btn-sm btn-secondary" href="{{ route('dashboard.models.edit', $item->users_auto_id) }}"><i class="fa fa-edit"></i> </a>

                                                                @endcan
                                                                @can('permission_delete')

                                                                    <form action="{{ route('dashboard.models.destroy', $item->users_auto_id) }}" method="POST" onsubmit="return confirm('Are you sure');" style="display: inline-block;">
