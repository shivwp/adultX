                        ...
                        <!-- PAGE-HEADER -->
                            ...
                            <div>
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Model Hair</a></li>
...
@section('content')
                        ...
                        <!-- ROW-1 OPEN-->
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <a href="{{ route('dashboard.model-hair.create') }}" class="btn btn-info-light ">
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    @foreach($model_hair as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                 ...
                                                                 <a class="btn btn-sm btn-secondary" href="{{ route('dashboard.model-hair.edit', $item->id) }}"><i class="fa fa-edit"></i> </a>

                                                                @endcan
                                                                @can('permission_delete')

                                                                    <form action="{{ route('dashboard.model-hair.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure');" style="display: inline-block;">
                                        ...
                                        <div id="pagination">{{{ $model_hair->links() }}}</div>
