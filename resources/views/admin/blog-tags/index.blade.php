...
@section('content')
                        <!-- ROW-1 OPEN-->
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <a href="{{ route('dashboard.blog-tags.create') }}" class="btn btn-info-light ">
                                    {{$buton_name}}
                                </a>
                            </div>
                                    <div class="card-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{--<a class="btn btn-sm btn-primary" href=""><i class="fa fa-eye"></i></a>--}}
                                                                 @can('coupon_edit')
                                                                 <a class="btn btn-sm btn-secondary" href="{{ route('dashboard.blog-tags.edit', $item->id) }}"><i class="fa fa-edit"></i> </a>
                                                                  @endcan
                                                                 @can('coupon_delete')
                                                                    <form action="{{ route('dashboard.blog-tags.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure');" style="display: inline-block;">
