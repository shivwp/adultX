			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<option value="vendor-signup" {{isset($mail) && ($mail->msg_category == 'vendor-signup') ? 'selected' : '' }}>Vendor Signup</option>

						<option value="contact-us-user" {{isset($mail) && ($mail->msg_category == 'contact-us-user') ? 'selected' : '' }}>Contact User </option>
