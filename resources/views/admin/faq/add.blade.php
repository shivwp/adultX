...
@section('content')
                        ...
                        <!-- ROW-1 OPEN-->
                                ...
                                <form  method="post" action="{{route('dashboard.faq.store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title" placeholder="Title" value="{{ old('title', isset($faq) ? $faq->title : '') }}" required>
                                             ...
                                             <!-- <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="arab_title" placeholder="Title" value="{{ old('title', isset($faq) ? $faq->arab_title : '') }}" required>
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="status" required>
                                                        ...
                                                        <option value="0" {{ isset($faq) && ($faq->status == 0) ? 'selected' : ''}}>Pending</option>
                                             ...
                                             <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <textarea class="form-control" name="description">{{ isset($faq) ? $faq->description : '' }}</textarea required>
                                              ...
                                              <!-- <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="form-label">Description (Arabic)</label>
                                                       ...
                                                       <textarea class="form-control" name="arab_description" required>{{ isset($faq) ? $faq->arab_description : '' }}</textarea>
