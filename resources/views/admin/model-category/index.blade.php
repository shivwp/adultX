...
@section('content')
                        ...
                        <!-- ROW-1 OPEN-->
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <a href="{{ route('dashboard.model-category.create') }}" class="btn btn-info-light ">
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    @foreach($model_cate as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                 ...
                                                                 <a class="btn btn-sm btn-secondary" href="{{ route('dashboard.model-category.edit', $item->id) }}"><i class="fa fa-edit"></i> </a>

                                                                @endcan
                                                                @can('permission_delete')

                                                                    <form action="{{ route('dashboard.model-category.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure');" style="display: inline-block;">
                                        ...
                                        <div id="pagination">{{{ $model_cate->links() }}}</div>
