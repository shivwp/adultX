  ...
  <div class="card-body" id="add_space">
    ...
    <form action="{{ route("dashboard.vendorsettings.store") }}" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
             <div class="form-group">
              <label class="control-label"> Store Banner Description</label>
              <textarea class="form-control" id="exampleInputuname_1" name="store_banner_desccription" >{{isset($data['store_banner_desccription']) ? $data['store_banner_desccription'] : '' }}</textarea>
            </div>
        </div>
