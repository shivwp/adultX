                                ...
                                <form  method="post" action="{{route('dashboard.notifications.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="id" value="{{ isset($blogcat) ? $blogcat->id : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title" placeholder="Title" value="{{ old('title', isset($blogcat) ? $blogcat->title : '') }}" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="arab_title" placeholder="Title" value="{{ old('title', isset($blogcat) ? $blogcat->arab_title : '') }}" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" class="form-control" name="body" placeholder="Body" value="{{ old('title', isset($blogcat) ? $blogcat->arab_title : '') }}" required></textarea> 
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" class="form-control" name="arab_body" placeholder="Title" value="{{ old('title', isset($blogcat) ? $blogcat->arab_title : '') }}" required></textarea> 
