...
<aside class="app-sidebar">
    <div class="side-header">
        <a class="header-brand1" href="{{ url('/' . ($page = 'index')) }}">
            ...
            <img src="{{ URL::asset('/images/logo/1657100822.png') }}" class="header-brand-img toggle-logo"
                alt="logo">
            <img src="{{ URL::asset('/images/logo/1657100822.png') }}" class="header-brand-img light-logo"
                alt="logo">
            <img src="{{ URL::asset('/images/logo/1657100822.png') }}" class="header-brand-img light-logo1"
                alt="logo">
        </a><!-- LOGO -->
    ...
    <div class="sidebar-navs">
        <ul class="nav  nav-pills-circle">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="top" title="Logout">
                <a href="{{ route('login') }}" class="nav-link text-center m-2"
    ...
    <ul class="side-menu mt-3">
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/dashboard') }}"><i
        ...
        @can('page_access')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#"><i
                        class="side-menu__icon fe fe-book-open"></i><span class="side-menu__label">Pages</span><i
        ...
        @can('blogs_access')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#"><i
                        class="side-menu__icon fe fe-message-square"></i><span class="side-menu__label">Feed</span><i
                        class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#"><i
                    class="side-menu__icon fa fa-commenting"></i><span class="side-menu__label">FAQ</span><i
                    class="angle fa fa-angle-right"></i></a>
            <ul class="slide-menu">
        ...
        @can('menu_access')
            <li>
                <a class="side-menu__item" href="{{ route('dashboard.menus.index') }}"><i
                        class="side-menu__icon icon icon-list"></i><span class="side-menu__label">Menus</span></a>
            </li>
        @endcan
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#"><i
                    class="side-menu__icon fa fa-users"></i><span class="side-menu__label">Models Management</span><i
                    class="angle fa fa-angle-right"></i></a>
            <ul class="slide-menu">
                <li><a href="{{ route('dashboard.models.index') }}" class="slide-item">Models</a></li>
                <li><a href="{{ route('dashboard.model-orientation.index') }}" class="slide-item">Model
                        Orientation</a></li>
                <li><a href="{{ route('dashboard.model-category.index') }}" class="slide-item">Model Category</a>
                </li>
                <li><a href="{{ route('dashboard.model-ethnicity.index') }}" class="slide-item">Model Ethnicity</a>
                </li>
                <li><a href="{{ route('dashboard.model-language.index') }}" class="slide-item">Model Language</a>
                </li>
                <li><a href="{{ route('dashboard.model-hair.index') }}" class="slide-item">Model Hair</a></li>
                <li><a href="{{ route('dashboard.model-fetishes.index') }}" class="slide-item">Model Fetishes</a>
                </li>
            </ul>
        </li>
        @can('fan_management')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#"> <i
                        class="side-menu__icon fa fa-users"></i><span class="side-menu__label">Fans</span><i
                        class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
                    <li><a href="{{ route('dashboard.fans.index') }}" class="slide-item">All fan</a></li>
                </ul>
            </li>
        @endcan
        @can('package_management')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#"> <i
                        class="side-menu__icon fa fa-money"></i><span class="side-menu__label">Packages</span><i
                        class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
                    <li><a href="{{ route('dashboard.packages.index') }}" class="slide-item">All Package</a></li>
                    <li><a href="{{ route('dashboard.packages.create') }}" class="slide-item">Add New</a></li>
                </ul>
            </li>
        @endcan
        @can('user_management_access')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#"> <i
                        class="side-menu__icon fe fe-user"></i><span class="side-menu__label">Users Management</span><i
                        class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
                    @can('role_access')
                    ...
                    @can('permission_access')
                        <li><a href="{{ route('dashboard.permissions.index') }}" class="slide-item">Role Permissions</a>
                        </li>
                    @endcan
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#"><i
                    class="side-menu__icon fe fe-settings"></i><span class="side-menu__label"> Web Settings</span><i
                    class="angle fa fa-angle-right"></i></a>
            <ul class="slide-menu">
        ...
        {{-- @can('support_access')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#"><i
                        class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Support</span><i
                        class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
                    <li><a href="{{ route('dashboard.support-tickets.index') }}" class="slide-item">All tickets</a>
                    </li>
                    <li><a href="{{ route('dashboard.support-category.index') }}" class="slide-item">Support
                            Category</a></li>
                </ul>
            </li>
        @endcan --}}
