...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        $d['phone']=Models::join('users','users.id','=','models.user_id')->select('models.*','users.*')->orderBy('users.created_at','asc')->where('models.phone','=',1)->get();
        ...
        $d['explore']=Models::join('users','users.id','=','models.user_id')->select('models.*','users.*')->orderBy('users.created_at','asc')->where('models.explore','=',1)->take(10)->get();
