...
Route::post('home-products', [App\Http\Controllers\Api\ProductApiController::class, 'homeProducts'] );
...
Route::post('releted-bid-products',[App\Http\Controllers\Api\ProductApiController::class, 'reletedbidproduct'])->name('releted-bid-products');
//product booking
Route::post('date-availability',[App\Http\Controllers\Api\OrderApiController::class, 'dateAvailability'])->name('date-availability'); 
//social
...
Route::post('trending-category',  [App\Http\Controllers\Api\ProductApiController::class, 'trendingCategory'] );
...
Route::post('category-product', [App\Http\Controllers\Api\ProductApiController::class, 'categoryProduct'] );
Route::post('category-subcategory', [App\Http\Controllers\Api\CategoryApiController::class, 'catSubcat'] );
...
//app-dashboard
Route::post('app-dashboard', [App\Http\Controllers\Api\ProductApiController::class, 'appdashboard']);
//Blogs
...
Route::middleware('auth:api')->group(function () {
    ...
    //Blog comment
Route::post('add-comment', [App\Http\Controllers\Api\BlogApiController::class, 'storecomment']);
//Notification
...
Route::post('remove-from-wishlist', [App\Http\Controllers\Api\WishlistApiController::class, 'removeWishlistdata'] );
Route::post('wishlist', [App\Http\Controllers\Api\WishlistApiController::class, 'index'] );
Route::post('change-password', [App\Http\Controllers\Api\UserApiController::class, 'userchangepassword']);
